...
namespace Lifts.Client.Static
{
    public static class Endpoints
    {
        ...
        public static readonly string VehicleBrandsEndpoint = $"{Prefix}/Brands";
        public static readonly string VehicleSeatersEndpoint = $"{Prefix}/Seaters";
        public static readonly string VehicleTypesEndpoint = $"{Prefix}/Types";
